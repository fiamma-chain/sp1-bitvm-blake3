...
mod tests {
    ...
    use sp1_verifier::{
        blake3_hash, decode_sp1_vkey_hash, hash_public_inputs, hash_public_inputs_with_fn,
        load_ark_groth16_verifying_key_from_bytes, load_ark_proof_from_bytes,
        load_ark_public_inputs_from_bytes, GROTH16_VK_BYTES,
    };
    ...
    fn test_groth16() {
        ...
        println!("native public input: {:?}", public_inputs);
